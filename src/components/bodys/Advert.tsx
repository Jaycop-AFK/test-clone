...
const Advert = (props: Props) => {
    return (
        <div style={{display: 'flex',flexDirection: 'column',}}>
            <a href='https://www.facebook.com/tiewtaitiewngai' target='_blank' rel='noopener noreferrer'>
                <img
            ...
            <a href='https://www.youtube.com/channel/UCfOgRKKLKvVcBvXo-6jpv3w' target='_blank' rel='noopener noreferrer'>
                <img
                    style={{ width: 700, height: 125 }}
